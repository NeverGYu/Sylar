...
AiUpload::AiUpload(ChatServer::ptr server)
    : Servlet("aimenu move")
    , m_server(server)
{}

int32_t AiUpload::handle(sylar::http::HttpRequest::ptr req, sylar::http::HttpResponse::ptr rsp,
        sylar::http::HttpSession::ptr session)
{
    try
    {
        ...
        std::string reqFile = chatserver::resourcePath("upload.html");
